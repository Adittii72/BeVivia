  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="rounded-2xl bg-white/70 backdrop-blur-xl border border-white/50 p-8 shadow-lg hover:shadow-xl transition-all duration-300">
          <h2 className="text-xl font-bold text-gray-900 mb-8 flex items-center gap-2">
            <span className="inline-block w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 text-white text-center leading-8 text-sm font-bold">
              📅
            </span>
            ...
            {[
              {
                ...
                items: [
                  'Segment customer database by risk level',
                  'Train support team on high-risk protocols',
              ...
              },
              {
                ...
                items: [
                  ...
                  'Begin proactive outreach calls'
                ]
              },
              {
                month: 'Month 3',
              ...
              <div key={idx} className="flex gap-6">
                <div className="flex-shrink-0 w-28">
                  <div className={`bg-gradient-to-br ${phase.color} text-white font-bold rounded-xl py-3 px-4 text-center`}>
                    {phase.month}
                  </div>
                </div>
                <div className="flex-1 p-5 bg-white/50 rounded-xl backdrop-blur-sm border border-white/60 hover:bg-white/70 transition-colors">
                  <h4 className="font-semibold text-gray-900 mb-3">{phase.title}</h4>
                  <ul className="space-y-2">
...
export default InsightsPage;
      ...
      {/* Implementation Timeline */}
      <div className="card">
        <h2 className="text-lg font-bold text-gray-900 mb-6">90-Day Implementation Plan</h2>
        <div className="space-y-4">
          <div className="flex gap-4">
            <div className="w-20 text-center">
              <div className="bg-blue-100 text-blue-700 font-bold rounded-lg py-2">Month 1</div>
            </div>
            <div className="flex-1">
              <h4 className="font-semibold text-gray-900 mb-2">Foundation</h4>
              <ul className="text-sm text-gray-700 list-disc list-inside space-y-1">
                <li>Segment customer database by risk level</li>
                <li>Train support team on high-risk protocols</li>
                <li>Set up automated alerts for high-risk predictions</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="w-20 text-center">
              <div className="bg-orange-100 text-orange-700 font-bold rounded-lg py-2">Month 2</div>
            </div>
            <div className="flex-1">
              <h4 className="font-semibold text-gray-900 mb-2">Execution</h4>
              <ul className="text-sm text-gray-700 list-disc list-inside space-y-1">
                <li>Launch targeted retention campaigns</li>
                <li>Implement personalized offer engine</li>
                <li>Begin proactive outreach calls</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <div className="w-20 text-center">
              <div className="bg-green-100 text-green-700 font-bold rounded-lg py-2">Month 3</div>
            </div>
            <div className="flex-1">
              <h4 className="font-semibold text-gray-900 mb-2">Optimization</h4>
              <ul className="text-sm text-gray-700 list-disc list-inside space-y-1">
                <li>Measure ROI of retention initiatives</li>
                <li>Refine targeting based on early results</li>
                <li>Prepare quarterly business review</li>
              </ul>
            </div>
          </div>
        </div>
